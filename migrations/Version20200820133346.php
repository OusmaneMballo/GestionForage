 ...
 */
final class Version20200820133346 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, numero VARCHAR(30) NOT NULL, date VARCHAR(15) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_351268BB19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compteur (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, numero VARCHAR(25) NOT NULL, etat VARCHAR(30) NOT NULL, INDEX IDX_4D021BD519EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE compteur ADD CONSTRAINT FK_4D021BD519EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compteur DROP FOREIGN KEY FK_4D021BD519EB6921');
